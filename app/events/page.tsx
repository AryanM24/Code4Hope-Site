...
const events = [
  ...
  },
  {
    ...
    cardDescription: "A collaborative hackathon hosted by Divergent Teams and Code4Hope at the Microsoft Office in New York City, where students developed impactful solutions in health and wellness, education, and sustainability.",
    logo: c4hxdivergent,
    fullDescription: "This exciting day of innovation took place at the Microsoft Office in New York City! This hackathon, co-hosted by Divergent Teams and Code4Hope, brought together students to solve problems and develop impactful solutions in three key categories: health and wellness, education, and sustainability. Participants explored various creative formats including games, presentations, documents, and other innovative solutions to showcase their creativity while making a meaningful impact. Participants worked individually or in teams of up to 4 members. With breakfast and lunch provided, and mentorship from directors and volunteers throughout the day, participants had everything they needed to bring their ideas to life. Each participant and team presented their project to judges with unique, creative, and impressive presentations. The event successfully engaged 125 students in this collaborative learning experience.",
    prizes: [
        { tier: "🏆 Prizes", value: "Prizes and awards were distributed to winning participants at the event." },
    ],
    sponsors: [
        { name: "Code4Hope", logo: "/c4hlogo_black.PNG" },
    ],
    links: [
        { name: "Event Website", url: "https://divergentteams.org/newyork-hackathon/#", type: "primary" as const },
    ],
    faq: [
        { question: "When did this event take place?", answer: "The hackathon took place on November 11, 2025, at the Microsoft Office in New York City." },
        { question: "What categories did projects focus on?", answer: "Projects focused on one of three impactful categories: health and wellness, education, or sustainability." },
        { question: "What was the team structure?", answer: "Participants worked individually or in groups of up to 4 members." },
        { question: "Was food provided?", answer: "Yes, breakfast and lunch were provided for all 125 participants." },
        { question: "Where was the event held?", answer: "The hackathon was held at the Microsoft Office in New York City." },
        { question: "Who organized this event?", answer: "This event was co-hosted by Divergent Teams and Code4Hope, with mentorship provided by directors and volunteers throughout the day." },
    ],
  },
  {
    id: "c4h-2025",
