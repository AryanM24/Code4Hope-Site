    ...
    <div className="flex flex-col min-h-screen">
      <main className="flex-grow">
        ...
        <section className="py-16 bg-[#F9FAFB] dark:bg-gray-900">
          ...
          >
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-[#1F2937] dark:text-white">Our Superstar Sponsors</h1>
        ...
        <ScrollReveal>
          <section className="py-12 md:py-16 lg:py-20 bg-[#F9FAFB] dark:bg-gray-900">
            <div className="container mx-auto px-4">
