    ...
    <footer className="border-t border-gray-200 dark:border-gray-800">
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="https://github.com/Code4Hope" className="text-gray-500 hover:text-primary transition-colors">
                <Github className="h-5 w-5" />
                <span className="sr-only">GitHub</span>
              </a>
              <a href="https://x.com/code4hope_" className="text-gray-500 hover:text-primary transition-colors">
                <Twitter className="h-5 w-5" />
                <span className="sr-only">Twitter</span>
              </a>
              <a href="https://linkedin.com/company/code4hope" className="text-gray-500 hover:text-primary transition-colors">
                <Linkedin className="h-5 w-5" />
                <span className="sr-only">LinkedIn</span>
              </a>
              <a href="mailto:events@code4hope.net" className="text-gray-500 hover:text-primary transition-colors">
        ...
        <div className="text-center mt-8 text-gray-500 dark:text-gray-500 text-sm flex items-center justify-center">
          ...
          <span>by the Code4Hope E-Board</span>
        </div>
      </div>
    </footer>
  )
