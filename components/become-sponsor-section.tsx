...
export function BecomeSponsorSection() {
    return (
        <section className="w-full max-w-3xl mx-auto text-center py-16">
            ...
            <Button
                className="w-full max-w-xl bg-primary hover:bg-charcoal text-white py-6 text-lg h-auto rounded-xl"
                onClick={() =>
                    window.open(
                        "https://docs.code4hope.net/img/sponsorship_prospectus.pdf",
                        "_blank"
                    )
                }
            >
